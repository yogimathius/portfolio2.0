...
const DarkModeToggle = () => {
  ...
  return (
    <div className="flex items-center">
      <span className="mr-2 text-sm text-gray-dark dark:text-gray-light">
        <svg
      ...
      <div className="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
        ...
        <label
          htmlFor="toggle"
          className="toggle-label block overflow-hidden h-6 rounded-full bg-gray-medium cursor-pointer"
          style={{
